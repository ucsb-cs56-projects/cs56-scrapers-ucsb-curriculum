...
public class UCSBCurriculumSearch {
    ...
    */
     ...
     *  return a null object
     @param String enrollment code
     @return UCSBSection object correlating to the right enrollment code
     */
    ...
    */
	...
	@param String array in the order of: Department (CMPSC), quarter (Spring), year (2014), and level (Undergraduate)
    */
	...
	@param String quarter e.g Summer, Winter, Fall, Spring
